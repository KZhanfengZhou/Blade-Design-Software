...
def One_dimension_init(blade_stage):
    ...
    alph0M = np.zeros(blade_stage)


def used_radial_and_geom_data_init(blade_stage, radial_stage):
    global c1i
    global alpha1i
    global Lambda1i
    global T1i
    ...
    global p2i
    global Radial_omega
    global Stator_Beta1_g
    global Stator_Beta2_g
    global Stator_Gamma
    global Stator_Cmax
    global Stator_r1
    global Stator_r2
    ...
    global Stator_z
    global Stator_B
    global Rotor_Beta1_g
    global Rotor_Beta2_g
    global Rotor_Gamma
    global Rotor_Cmax
    global Rotor_r1
    global Rotor_r2
    ...
    c1i = np.zeros([blade_stage, radial_stage])
    alpha1i = np.zeros([blade_stage, radial_stage])
    Lambda1i = np.zeros([blade_stage, radial_stage])
    T1i = np.zeros([blade_stage, radial_stage])
    p1i = np.zeros([blade_stage, radial_stage])
    Beta1i = np.zeros([blade_stage, radial_stage])

    w1i = np.zeros([blade_stage, radial_stage])
    Ma_w1i = np.zeros([blade_stage, radial_stage])
    w2i = np.zeros([blade_stage, radial_stage])
    Beta2i = np.zeros([blade_stage, radial_stage])
    RLambda2i = np.zeros([blade_stage, radial_stage])
    T2i = np.zeros([blade_stage, radial_stage])
    p2i = np.zeros([blade_stage, radial_stage])
    Radial_omega = np.zeros([blade_stage, radial_stage])

    Stator_Beta1_g = np.zeros([blade_stage, radial_stage])
    Stator_Beta2_g = np.zeros([blade_stage, radial_stage])
    Stator_Gamma = np.zeros([blade_stage, radial_stage])
    Stator_Cmax = np.zeros([blade_stage, radial_stage])
    Stator_r1 = np.zeros([blade_stage, radial_stage])
    Stator_r2 = np.zeros([blade_stage, radial_stage])
    Stator_t = np.zeros([blade_stage, radial_stage])
    Stator_z = np.zeros([blade_stage, radial_stage])
    Stator_B = np.zeros([blade_stage, radial_stage])

    Rotor_Beta1_g = np.zeros([blade_stage, radial_stage])
    Rotor_Beta2_g = np.zeros([blade_stage, radial_stage])
    Rotor_Gamma = np.zeros([blade_stage, radial_stage])
    Rotor_Cmax = np.zeros([blade_stage, radial_stage])
    Rotor_r1 = np.zeros([blade_stage, radial_stage])
    Rotor_r2 = np.zeros([blade_stage, radial_stage])
    Rotor_t = np.zeros([blade_stage, radial_stage])
    Rotor_z = np.zeros([blade_stage, radial_stage])
    Rotor_B = np.zeros([blade_stage, radial_stage])
